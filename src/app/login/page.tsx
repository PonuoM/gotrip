      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-2.5">
          ...
          <div className="flex items-center gap-2.5 my-5">
            ...
            <div className="text-[10px] font-bold tracking-[2px] text-gray-500">{t('login.or')}</div>
            <div className="flex-1 h-px bg-gray-200" />
          </div>
          ...
          {!showEmail ? (
            ...
            <form onSubmit={handleMagicLink} className="space-y-2.5">
              ...
              >
                {loading ? t('login.sending') : t('login.magic_send')}
              </button>
            </form>
          )}
        ...
        <div className="mt-10 text-center text-[10px] font-medium text-gray-500 leading-relaxed">
          {t('login.agree')}<br/>
          <a className="underline text-brand-black" href="/terms">{t('login.terms')}</a>
          {' · '}
          <a className="underline text-brand-black" href="/privacy">{t('login.privacy')}</a>
        </div>
      </div>
    </main>
  )
